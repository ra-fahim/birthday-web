...
const ALLOWED = new Set(['master','birthday','anniversary','proposal','wedding','sorry','miss-you','thank-you','congratulations','graduation','friendship','surprise','festival','romantic','cute','luxury','anime','gaming','minimal','elegant','festival-style']);

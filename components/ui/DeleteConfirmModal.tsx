...
export default function DeleteConfirmModal({
  ...
  return <>
    ...
    {open && <div className="confirm-backdrop" role="presentation" onMouseDown={() => !busy && setOpen(false)}>
      <div className="confirm-modal" role="dialog" aria-modal="true" aria-labelledby="delete-title" onMouseDown={e => e.stopPropagation()}>

import{a as n,j as e,m as h,A as U}from"./motion-C6c_ebrr.js";import{T as q}from"./Toast-DMlqsg_3.js";import{c as l,g as A,H as D,P}from"./index-CX-eZNSF.js";import"./vendor-B945N0Jz.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const se=[["path",{d:"M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z",key:"1s2grr"}],["path",{d:"M20 2v4",key:"1rf3ol"}],["path",{d:"M22 4h-4",key:"gwowj6"}],["circle",{cx:"4",cy:"20",r:"2",key:"6kqj1y"}]],oe=l("sparkles",se);/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const re=[["path",{d:"M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z",key:"qn84l0"}],["path",{d:"M13 5v2",key:"dyzc3o"}],["path",{d:"M13 17v2",key:"1ont0d"}],["path",{d:"M13 11v2",key:"1wjjxi"}]],y=l("ticket",re),x={recipientEmail:"rabbiahmedfahim44@gmail.com",toName:"Rodney (The Best Boyfriend)",fromName:"Sherry (Your Valentine)",fromLabel:"Sherry"};let b=null;function ne(){var s,d,p,m;if(b)return b;const i=A();return b={recipientEmail:((s=i.recipientEmail)==null?void 0:s.trim())||x.recipientEmail,toName:((d=i.toName)==null?void 0:d.trim())||x.toName,fromName:((p=i.fromName)==null?void 0:p.trim())||x.fromName,fromLabel:((m=i.fromLabel)==null?void 0:m.trim())||x.fromLabel},b}const C=[e.jsx(_,{className:"w-6 h-6"}),e.jsx(L,{className:"w-6 h-6"}),e.jsx(P,{className:"w-6 h-6"}),e.jsx(O,{className:"w-6 h-6"}),e.jsx(y,{className:"w-6 h-6"}),e.jsx(I,{className:"w-6 h-6"}),e.jsx(E,{className:"w-6 h-6"})],ie=[{id:"massage",label:"Massage & Class",icon:e.jsx(_,{className:"w-6 h-6"}),planTitle:"The Stress Melter",planDescription:"Multitasking at its finest. While you attend your online class, I'll be your personal masseur. I'll give you a full body massage to help you relax and recharge before you have to clock in at 5 PM.",budget:"Free"},{id:"preshift",label:"Pre-Work Recharge",icon:e.jsx(L,{className:"w-6 h-6"}),planTitle:"The 30-Minute Power Date",planDescription:"I know you're busy between class and work. I'll meet you right in that gap. I'll bring you food/coffee, we'll sit for a bit, and I'll hype you up before your 5 PM shift starts.",budget:"$"},{id:"color",label:"Color Challenge",icon:e.jsx(P,{className:"w-6 h-6"}),planTitle:"The Color Snack Challenge",planDescription:"We pick a random color (Pink? Blue? Red?) and head to the nearest convenience store. We can only buy and eat snacks/drinks that match that color!",budget:"$$"},{id:"arcade",label:"Arcade & Ice Cream",icon:e.jsx(O,{className:"w-6 h-6"}),planTitle:"Retro Arcade Duel",planDescription:"We hit the arcade. Air hockey, basketball, and crane games. Loser buys the winner ice cream afterwards (but let's be honest, I'll buy it anyway).",budget:"$$"},{id:"movie",label:"Laptop Cinema",icon:e.jsx(y,{className:"w-6 h-6"}),planTitle:"Dorm/Room Movie Night",planDescription:"I'll bring the popcorn and snacks. We build a blanket nest and watch that movie you've been wanting to see on your laptop.",budget:"$"},{id:"study",label:"Study & Sip",icon:e.jsx(I,{className:"w-6 h-6"}),planTitle:"Coffee Shop Focus Date",planDescription:"We'll find a quiet corner at a cute cafe. I'll buy the coffee/boba, you bring the notes. 50% studying, 50% holding hands under the table.",budget:"$"},{id:"capitaltown",label:"Capital Town",icon:e.jsx(E,{className:"w-6 h-6"}),planTitle:"Capital Town Anniversary Redo",planDescription:"We missed going here for our anniversary, but we're making up for it now. Let's finally have that date at Capital Town Pampanga. We'll walk around, grab food, and enjoy the vibe before your schedule gets busy.",budget:"$$",isSpecial:!0}],he=()=>{var j,T,S;const s=A().datePlanner||{},d=((j=s.heading)==null?void 0:j.trim())||"Let's Plan Our Date Together",p=((T=s.subtitle)==null?void 0:T.trim())||"Pick what your heart desires.",m=((S=s.sendButtonLabel)==null?void 0:S.trim())||"Send Ticket",v=s.options&&s.options.length?s.options.map((a,c)=>({id:a.id||`custom-${c}`,label:a.label,planTitle:a.planTitle,planDescription:a.planDescription,budget:a.budget||"$",isSpecial:a.isSpecial,icon:C[c%C.length]})):ie,[u,B]=n.useState(null),[o,W]=n.useState("Afternoon (Before Work)"),[R,k]=n.useState(!1),[V,f]=n.useState(""),[z,w]=n.useState("success"),[r,N]=n.useState(!1),t=v.find(a=>a.id===u),F=async()=>{if(!t||r)return;N(!0);const a=ne(),c=a.recipientEmail,M=`Date Ticket: ${t.planTitle}`,g=`
...
Love always,
${a.fromLabel}
    `,H=`<pre style="font-family:ui-monospace,monospace;white-space:pre-wrap;font-size:14px;line-height:1.5;">${g.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</pre>`;try{if(!(await fetch("/api/send-ticket",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:c,subject:M,text:g,html:H})})).ok)throw new Error("send failed");w("success"),f(`Date ticket sent! "${t.planTitle}" is on its way to ${a.toName.split(" (")[0]}!`),k(!0)}catch{const $=`mailto:${c}?subject=${encodeURIComponent(M)}&body=${encodeURIComponent(g)}`;window.location.href=$,w("error"),f("Auto-send is unavailable right now, opening your mail app instead."),k(!0)}finally{N(!1)}};return e.jsxs("div",{className:"w-full max-w-6xl mx-auto text-center px-4",children:[e.jsxs("div",{className:"mb-12",children:[e.jsx("h2",{className:"font-serif text-3xl md:text-5xl mb-4 text-love-text dark:text-love-dark-text",children:d}),e.jsx("p",{className:"text-love-accent dark:text-love-dark-accent/80 mb-2",children:p})]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12",children:v.map(a=>e.jsxs(h.button,{onClick:()=>B(a.id),className:`
            ...
            `,whileHover:{y:-5},whileTap:{scale:.95},animate:a.isSpecial?{boxShadow:["0px 0px 0px rgba(251, 191, 36, 0)","0px 0px 15px rgba(251, 191, 36, 0.3)","0px 0px 0px rgba(251, 191, 36, 0)"]}:{},transition:a.isSpecial?{duration:2,repeat:1/0}:{},children:[a.isSpecial&&e.jsx("div",{className:"absolute top-3 right-3 text-amber-500 animate-pulse",children:e.jsx(oe,{className:"w-4 h-4"})}),e.jsx("div",{className:`
            ...
            `,children:a.icon}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{className:`font-serif text-lg leading-tight ${a.isSpecial?"font-bold text-amber-800 dark:text-amber-200":"text-love-text dark:text-love-dark-text"}`,children:a.label}),e.jsx("span",{className:"text-xs uppercase tracking-wider text-love-accent/60 dark:text-love-dark-accent/60 mt-2",children:a.isSpecial?"Extra Special":`Budget: ${a.budget}`})]})]},a.id))}),e.jsx("div",{className:"min-h-[450px] flex justify-center items-start",children:e.jsx(U,{mode:"wait",children:t?e.jsx(h.div,{initial:{opacity:0,rotateX:-90,y:-20},animate:{opacity:1,rotateX:0,y:0},exit:{opacity:0,rotateX:90,y:20},transition:{type:"spring",damping:20},className:"relative w-full max-w-md mx-auto",children:e.jsxs("div",{className:`
              ...
              `,children:[e.jsxs("div",{className:`
                ...
                `,children:[e.jsx("span",{className:"text-xs font-bold tracking-[0.2em] uppercase",children:"Admit One"}),e.jsx(D,{className:"w-4 h-4 fill-current"}),e.jsx("span",{className:"text-xs font-bold tracking-[0.2em] uppercase",children:t.isSpecial?"VIP Date":"Date Night"})]}),e.jsxs("div",{className:"p-8 text-center relative",children:[e.jsx("div",{className:"absolute inset-0 flex items-center justify-center opacity-[0.03] pointer-events-none",children:e.jsx(D,{className:"w-48 h-48"})}),e.jsx("h3",{className:"font-serif text-2xl md:text-3xl text-love-text dark:text-love-dark-text mb-4",children:t.planTitle}),e.jsx("p",{className:"text-sm md:text-base text-love-text/70 dark:text-love-dark-text/70 leading-relaxed mb-6",children:t.planDescription}),e.jsxs("div",{className:"mb-6 p-4 bg-love-bg dark:bg-black/20 rounded-lg border border-love-accent/10 dark:border-love-dark-accent/10",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2 mb-2 text-love-accent dark:text-love-dark-accent",children:[e.jsx(Y,{className:"w-4 h-4"}),e.jsx("span",{className:"text-xs font-bold uppercase tracking-widest",children:"Select Time"})]}),e.jsxs("select",{value:o,onChange:a=>W(a.target.value),className:"w-full bg-white dark:bg-love-dark-card border border-love-accent/20 dark:border-love-dark-accent/20 rounded px-3 py-2 text-sm text-love-text dark:text-love-dark-text focus:outline-none focus:ring-1 focus:ring-love-accent",children:[e.jsx("option",{value:"Online Class (Before 5 PM)",children:"During Online Class (Before 5 PM)"}),e.jsx("option",{value:"Morning (10:00 AM - 12:00 PM)",children:"Morning (10 AM - 12 PM)"}),e.jsx("option",{value:"Lunch Break (12:00 PM - 2:00 PM)",children:"Lunch Break (12 PM - 2 PM)"}),e.jsx("option",{value:"Early Afternoon (2:00 PM - 4:00 PM)",children:"Early Afternoon (2 PM - 4 PM)"}),e.jsx("option",{value:"After Work (After 5:00 PM)",children:"After Work (Post 5 PM)"}),e.jsx("option",{value:"Weekend (All Day)",children:"Weekend (All Day)"})]}),o.includes("Morning")||o.includes("Afternoon")||o.includes("Lunch")||o.includes("Class")?e.jsx("p",{className:"mt-2 text-[10px] text-love-accent dark:text-love-dark-accent",children:"*Will ensure you're ready for work by 5:00 PM"}):null]}),e.jsx("div",{className:"w-full h-px bg-love-accent/20 dark:bg-love-dark-accent/20 mb-6"}),e.jsxs(h.button,{onClick:F,disabled:r,className:`

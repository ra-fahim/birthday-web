...
['romantic','Romantic','Soft romantic style','romantic'],['cute','Cute','Playful style','cute'],['luxury','Luxury','Premium elegant style','luxury'],['anime','Anime','Anime-inspired style','anime'],['gaming','Gaming','Gaming style','gaming'],['minimal','Minimal','Clean minimal style','minimal'],['elegant','Elegant','Classic elegant style','elegant']
].map(([slug,name,description,category])=>({slug,name,category,description}));

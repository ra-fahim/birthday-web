...
export const defaultContent:BirthdayContent={
 ...
 theme:'romantic',font:'sans',primaryColor:'#ec4899',buttonText:'Make a Wish',cakeNextButton:'Next',reasonsButton:'Continue',photoTitle:'Our Memories',photoSubtitle:'A few moments worth keeping forever.',photoNextButton:'Next',videoTitle:'A Special Video Message',videoNextButton:'Next',letterTitle:'A Letter For You',letterButton:'Read my letter',secretTitle:'One Last Surprise',secretButton:'Open the surprise',countdown:true,confetti:true,fireworks:true,hearts:true,balloons:true,
